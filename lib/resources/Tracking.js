module.exports.init = function (USPS) {
    ...
    */
    USPS.prototype.tracking = function (id, cb) {
        ...
        if (!id) return cb('must provide a tracking id as first argument. you provided: ' + id);
        if (typeof id !== 'string') return cb('must provide a tracking id as first argument. you provided: ' + id);
        ...
        this._request(url, function (err, json) {
            ...
            try {
                ...
                cb('Tracking: no record of that item');
            }
